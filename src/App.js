...
const CATALYST_CATEGORIES = [
  ...
  },
  {
    ...
    keywords: [
      ...
      // broader earnings coverage
      "beats earnings", "after earnings", "earnings flash", "earnings beat",
      "earnings miss", "tops forecast", "tops q1", "tops q2", "tops q3", "tops q4",
      ...
      "annual results", "revenue growth", "guides higher", "guides lower",
      "raised guidance", "lowered guidance", "full-year guidance",
      "fiscal q1", "fiscal q2", "fiscal q3", "fiscal q4",
      "net loss", "net income", "eps beat", "eps miss",
      "revenue beat", "revenue miss", "surpassed expectations",
      "plunging after earnings", "climbs after earnings", "rallies after earnings",
      "stock rises after", "stock falls after", "stock drops after",
    ],
  },
  {
    key: "ma",
