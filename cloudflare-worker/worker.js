/**
 * Bar-data proxy for the Trade Journal's chart modal (TradeChartModal in
 * src/App.js), which renders candles with TradingView's Lightweight Charts
 * (Apache-2.0, npm package "lightweight-charts" — not the licensed "Advanced
 * Charts" library).
 *
 ...
 * the browser can fetch real OHLCV bars for whatever ticker/date range a
 * trade needs.
 *
 * Endpoint:
